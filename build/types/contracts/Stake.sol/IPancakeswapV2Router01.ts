...
export interface IPancakeswapV2Router01Interface extends utils.Interface {
  functions: {
...
export interface IPancakeswapV2Router01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeswapV2Router01Interface;
