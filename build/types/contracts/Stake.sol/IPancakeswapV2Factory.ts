...
export interface IPancakeswapV2FactoryInterface extends utils.Interface {
  functions: {
...
export interface IPancakeswapV2Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeswapV2FactoryInterface;
