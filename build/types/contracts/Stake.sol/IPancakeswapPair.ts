...
export interface IPancakeswapPairInterface extends utils.Interface {
  functions: {
...
export interface IPancakeswapPair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPancakeswapPairInterface;
